...
const PORT = 22218 //ubdah port sesuai dengan NPM kalian masing - masing. contoh: jika npm 54422423 maka portnya 22423

func main() {
	http.HandleFunc("/api/mahasiswa", user)                         // buat route untuk api/mahasiswa
	http.Handle("/", http.FileServer(http.Dir("polymer_50422218"))) // buat route untuk file statis
